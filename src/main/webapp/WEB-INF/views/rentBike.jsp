            ...
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <small class="text-muted">
                        $${selectedBike.pricePerHour * 20}/day
                    </small>
                </div>
            </div>
        </div>
        ...
        <form action="/rentals/rent" method="post">
            ...
            <div class="mb-3">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <select name="bikeId" id="bikeSelect" class="form-select" required>
                            <option value="">-- Select a bike --</option>
                            <c:forEach var="b" items="${availableBikes}">
                                <option value="${b.id}" data-price="${b.pricePerHour}">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex gap-3">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="daily">Daily (cheaper than hourly)</label>
                    </div>
                </div>
            </div>
