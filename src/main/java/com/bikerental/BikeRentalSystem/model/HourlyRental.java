...
public class HourlyRental extends Rental {
    ...
    public HourlyRental(String id, String userId, String bikeId, String startStation, String endStation,
                        String startTime, String endTime, double cost, String status) {
        super(id, userId, bikeId, startStation, endStation, startTime, endTime, cost, status, "HOURLY");
    }
